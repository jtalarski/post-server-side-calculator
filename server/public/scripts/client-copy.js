...
function onReady() {
    ...
    $(document).on('click', '#addition', addition);
    $(document).on('click', '#subtraction', subtraction);
    $(document).on('click', '#multiplicaton, multiplication);
            $(document).on('click', '#division', division); $(document).on('click', '#equalsBtn', addEquation); $(document).on('click', '#clearBtn', clearInput); getEquation();
        } // end onReady
